...
%PYTHON_EXE% -m pip install onnx==1.19.0 onnxscript==0.5.7 --no-cache-dir --trusted-host  http://mirrors.aliyun.com/pypi/simple/
%PYTHON_EXE% -m pip install onnxruntime-gpu>=1.19.0 --no-cache-dir --trusted-host http://mirrors.aliyun.com/pypi/simple/
...
%PYTHON_EXE% -m pip install windows-capture==1.5.0 --no-cache-dir --trusted-host  http://mirrors.aliyun.com/pypi/simple/
